...
<section class="heading">
    <h3>Panier</h3>
    <p> <a href="home.php">home</a> / Panier </p>
</section>
...
<section class="shopping-cart">
    ...
    <div class="more-btn">
        <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('delete all from cart?');">Vider le panier </a>
    </div>

    <div class="cart-total">
        <p>Somme finale : <span>$<?php echo $grand_total; ?>/-</span></p>
        <a href="shop.php" class="option-btn">continuer shopping</a>
        <a href="checkout.php" class="btn  <?php echo ($grand_total > 1)?'':'disabled' ?>">Confirmer</a>
    </div>
