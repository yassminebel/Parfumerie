...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select_users) > 0){
      ...
      if($pass != $cpass){
         $message[] = 'Confirmer le mot de passe correspondant !';
      }else{
         mysqli_query($conn, "INSERT INTO `users`(name, email, password) VALUES('$name', '$email', '$pass')") or die('query failed');
         $message[] = 'Enregisté avec succès!';
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" class="box" placeholder="entez votre e-mail" required>
      <input type="password" name="pass" class="box" placeholder="entez votre mot de passe" required>
