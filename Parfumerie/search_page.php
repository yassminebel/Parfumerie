...
<section class="heading">
    ...
    <p> <a href="home.php">home</a> / Recherche </p>
</section>
...
<section class="products" style="padding-top: 0;">
   ...
   <div class="box-container">
      ...
      <form action="" method="POST" class="box">
         ...
         <input type="submit" value="Ajouter au panier" name="add_to_wishlist" class="option-btn">
         <input type="submit" value="Liste de souhaits" name="add_to_cart" class="btn">
      </form>
      <?php
         }
            }else{
