...
<header class="header">
   ...
   <div class="flex">
      ...
      <a href="admin_page.php" class="logo">Panneau<span> d'Administration</span></a>
      ...
      <div class="account-box">
         ...
         <a href="logout.php" class="delete-btn">Se deconnecter</a>
         <div>new <a href="login.php">Se connecter</a> | <a href="register.php">S'inscrire'</a> </div>
      </div>
